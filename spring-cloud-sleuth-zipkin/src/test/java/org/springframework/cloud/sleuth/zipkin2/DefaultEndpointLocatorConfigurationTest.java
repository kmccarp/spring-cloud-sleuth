...
public class DefaultEndpointLocatorConfigurationTest {
	...
	@Test
    void endpointLocatorShouldDefaultToServerPropertiesEndpointLocator() {
	...
	@Test
    void endpointLocatorShouldDefaultToServerPropertiesEndpointLocatorEvenWhenDiscoveryClientPresent() {
		ConfigurableApplicationContext ctxt = new SpringApplication(
	...
	@Test
    void endpointLocatorShouldRespectExistingEndpointLocator() {
		ConfigurableApplicationContext ctxt = new SpringApplication(
	...
	@Test
    void endpointLocatorShouldSetServiceNameToServiceId() {
		ConfigurableApplicationContext ctxt = new SpringApplication(
				ConfigurationWithRegistration.class).run("--spring.jmx.enabled=false",
	...
	@Test
    void endpointLocatorShouldAcceptServiceNameOverride() {
		ConfigurableApplicationContext ctxt = new SpringApplication(
				ConfigurationWithRegistration.class).run("--spring.jmx.enabled=false",
				"--spring.zipkin.locator.discovery.enabled=true",
	...
	@Test
    void endpointLocatorShouldRespectExistingEndpointLocatorEvenWhenAskedToBeDiscovery() {
		ConfigurableApplicationContext ctxt = new SpringApplication(
	...
	@Test
    void portDefaultsTo8080() throws UnknownHostException {
	...
	@Test
    void portFromServerProperties() throws UnknownHostException {
	...
	@Test
    void portDefaultsToLocalhost() throws UnknownHostException {
		DefaultEndpointLocator locator = new DefaultEndpointLocator(null,
	...
	@Test
    void hostFromServerPropertiesIp() throws UnknownHostException {
		ServerProperties properties = new ServerProperties();
	...
	@Test
    void appNameFromProperties() throws UnknownHostException {
		ServerProperties properties = new ServerProperties();
	...
	@Test
    void negativePortFromServerProperties() throws UnknownHostException {
		ServerProperties properties = new ServerProperties();
