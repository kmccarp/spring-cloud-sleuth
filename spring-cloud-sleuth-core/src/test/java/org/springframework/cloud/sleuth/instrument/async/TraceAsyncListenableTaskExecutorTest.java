...
public class TraceAsyncListenableTaskExecutorTest {
	...
	@Test
    void should_submit_listenable_trace_runnable() throws Exception {
	...
	@Test
    void should_submit_listenable_trace_callable() throws Exception {
		Span span = this.tracer.nextSpan().name("foo");
	...
	@Test
    void should_execute_a_trace_runnable() throws Exception {
		AtomicBoolean executed = new AtomicBoolean();
		Span span = this.tracer.nextSpan().name("foo");
	...
	@Test
    void should_execute_with_timeout_a_trace_runnable() throws Exception {
		AtomicBoolean executed = new AtomicBoolean();
		Span span = this.tracer.nextSpan().name("foo");
	...
	@Test
    void should_submit_trace_callable() throws Exception {
		Span span = this.tracer.nextSpan().name("foo");
		Span spanFromListenable;
	...
	@Test
    void should_submit_trace_runnable() throws Exception {
		AtomicBoolean executed = new AtomicBoolean();
		Span span = this.tracer.nextSpan().name("foo");
