...
public class BraveTracerTest {
  ...
  @Autowired BraveTracer opentracing;
    ...
    @Test
    void startWithOpenTracingAndFinishWithBrave() {
    ...
    @Test
    void extractTraceContext() throws Exception {
    ...
    @Test
    void extractBaggage() throws Exception {
        Map<String, String> map = new LinkedHashMap<>();
        map.put("X-B3-TraceId", "0000000000000001");
        map.put("X-B3-SpanId", "0000000000000002");
        map.put("X-B3-Sampled", "1");
    ...
    @Test
    void extractTraceContextTextMap() throws Exception {
        Map<String, String> map = new LinkedHashMap<>();
        map.put("X-B3-TraceId", "0000000000000001");
        map.put("X-B3-SpanId", "0000000000000002");
        map.put("X-B3-Sampled", "1");
    ...
    @Test
    void extractTraceContextCaseInsensitive() throws Exception {
        Map<String, String> map = new LinkedHashMap<>();
        map.put("X-B3-TraceId", "0000000000000001");
        map.put("x-b3-spanid", "0000000000000002");
        map.put("x-b3-SaMpLeD", "1");
    ...
    @Test
    void injectTraceContext_baggage() throws Exception {
  ...
  void checkSpanReportedToZipkin() {
    ...
    @Test
    void subsequentChildrenNestProperly_OTStyle() {
    ...
    @Test
    void subsequentChildrenNestProperly_BraveStyle() {
    ...
    @Test
    void implicitParentFromSpanManager_startActive() {
    ...
    @Test
    void implicitParentFromSpanManager_start() {
        try (Scope scopeA = opentracing.buildSpan("spanA").startActive(true)) {
    ...
    @Test
    void implicitParentFromSpanManager_startActive_ignoreActiveSpan() {
        try (Scope scopeA = opentracing.buildSpan("spanA").startActive(true)) {
    ...
    @Test
    void implicitParentFromSpanManager_start_ignoreActiveSpan() {
        try (Scope scopeA = opentracing.buildSpan("spanA").startActive(true)) {
    ...
    @Test
    void ignoresErrorFalseTag_beforeStart() {
    ...
    @Test
    void ignoresErrorFalseTag_afterStart() {
        opentracing.buildSpan("encode")
                .start()
                .setTag("error", false)
                .finish();
